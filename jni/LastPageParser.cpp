...
#include <jni.h>
#include "include/com_example_journal_LastPageParser.h"
...
Java_com_example_journal_LastPageParser_parsePage(JNIEnv *env, jobject thisObj, jstring page_path, jstring file_path)
{
	_lessons.clear();
	_marks.clear();
